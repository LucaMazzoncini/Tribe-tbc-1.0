using GameEventManagement;using UnityEngine;
using System.Collections;
using System.Collections.Generic;
using GameEventManagement;
public class UpdateManaScriptP3 : MonoBehaviour {

    private const string MANA = "Fire";
    ...
    {
        if (on == null)
            on = Resources.Load("Materials/Mana_P_red_tapped") as Texture;
        if (off == null)
            off = Resources.Load("Materials/Mana_P_red") as Texture;
