...
public class UpdateManaScriptP2 : MonoBehaviour {

    private const string MANA = "Earth";
    ...
    {
        if (on == null)
            on = Resources.Load("Materials/Mana_P_brow_tapped") as Texture;
        if (off == null)
            off = Resources.Load("Materials/Mana_P_brow") as Texture;
